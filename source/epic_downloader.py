# The code was taken from the GitHub repo:
# https://github.com/epic-kitchens/epic-kitchens-download-scripts?tab=readme-ov-file
...
class EpicDownloader:
    def __init__(self,
                 ...
                 splits_path_epic_55='data/source/epic_55_splits.csv',
                 splits_path_epic_100='data/source/epic_100_splits.csv',
                 md5_path='data/source/md5.csv',
                 errata_path='data/source/errata.csv',
                 errata_only=False):
    ...
    def download(self, what=('videos', 'rgb_frames', 'flow_frames'), participants='all', specific_videos='all',
                 splits='all',
...
def create_parser():
    ...
    parser.add_argument('--specific-videos', nargs='?', type=str, default='all',
                        help='Specify video IDs. You can specify a single video, e.g. `--participants P01_01` '
...
if __name__ == '__main__':
    ...
    downloader.download(what=args.what, participants=args.participants, specific_videos=args.specific_videos,
                        splits=args.splits, challenges=args.challenges,
